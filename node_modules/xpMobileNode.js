 ...
 * @method xpMobileNode
 * @param  {integer}     id An preogressive input integer, used to label different xpMobileNode(s)
 ...
 * @param  {xpMobileNode}    objRef A reference to access the specific xpMobileNode node list.
 */
 ...
 * @param  {xpMobileNode}        objRef A reference to the specific xpMobileNode where to start the announce service.
 * 
 */
xpMobileNode.prototype.announceService = function(objRef) {
	...
	//NOTE: We have only one device in a xpMobileNode instance
};
/**
 ...
 * You must override it for a most specialized behaviour when 
 * an action has been received. 
 * @method dispatchAction
 * @param  {HashTable}       action The action hashtable received from the xPlaces network
 * @param  {xpMobileNode}       objRef A reference to the specific xpMobileNode used to check if session code matchs.
 * 
 */
 ...
 * @param  {xpMobileNode}          objRef A reference to access a specific xpMobileNode datagram socket
 * 
 */
 ...
 * @param  {xpMobileNode}         objRef A reference to a specific xpMobileNode instance.
 * 
 */
...
********************************************************************** */
/**
 * Creates a custom xpEvent obj and sends it to listeners. Overwrite it to implements your own logic.
